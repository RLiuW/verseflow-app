...
import 'package:siemb/screens/admin/tiles/admin_user_card.dart';
          ...
          slivers: <Widget>[
            ...
            SliverFillRemaining(
                child: Column(
                  children: <Widget>[
                    StreamBuilder(
                        stream: _data.collection('usuarios')
                            .snapshots(),
                        builder: (BuildContext context, AsyncSnapshot<
                            QuerySnapshot> snapshot) {
                          if ((snapshot.data?.docs.length ?? 0) == 0){
                            return Center(
                              child: Text(l10n.noUsersRegistered,
                          ...
                          return Expanded(
                            child: ListView.separated(
                              ...
                              itemBuilder: (context, index) => AdminUserCard(docs[index]),
                            ),
                          );
                        }
                    ),
